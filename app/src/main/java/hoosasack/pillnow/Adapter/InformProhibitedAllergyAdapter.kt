 ...
 */
class InformProhibitedAllergyAdapter(private val context : Context, items: List<InformProhibitedAllergyData>) : BaseAdapter() {
    private var items = listOf<InformProhibitedAllergyData>()
    ...
    override fun getView(i: Int, convertView: View?, viewGroup: ViewGroup): View {
        ...
        view = inflater.inflate(R.layout.item_inform_content, null)
