 ...
 */
class SearchCustomAdapter(private val context : Context, items: List<SearchCustomData>) : BaseAdapter() {
    private var items = listOf<SearchCustomData>()
    ...
    override fun getView(i: Int, convertView: View?, viewGroup: ViewGroup): View {
        ...
        view = inflater.inflate(R.layout.item_scan_custom_input, null)
